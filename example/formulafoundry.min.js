...
"use strict";function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var r={};if(null!=e)for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(r[n]=e[n]);return r["default"]=e,r}function compile(e){function r(e){return e.map(function(e){return"function() { return ("+t(e)+") }"}).join(", ")}function n(e){return e.map(function(e){return t(e)}).join(", ")}function t(e){var u=void 0,i=void 0;switch(e.type){case"operator":switch(e.subtype){case"prefix-plus":return c+"numbervalue("+n(e.operands)+")";case"prefix-minus":return c+"-numbervalue("+n(e.operands)+")";case"infix-add":return s.push("add"),c+"add("+n(e.operands)+")";case"infix-subtract":return s.push("subtract"),c+"subtract("+n(e.operands)+")";case"infix-multiply":return s.push("multiply"),c+"multiply("+n(e.operands)+")";case"infix-divide":return s.push("divide"),c+"divide("+n(e.operands)+")";case"infix-power":return s.push("power"),c+"power("+n(e.operands)+")";case"infix-concat":return s.push("concatenate"),c+"concatenate("+n(e.operands)+")";case"infix-eq":return s.push("eq"),c+"eq("+n(e.operands)+")";case"infix-ne":return s.push("ne"),c+"ne("+n(e.operands)+")";case"infix-gt":return s.push("gt"),c+"gt("+n(e.operands)+")";case"infix-gte":return s.push("gte"),c+"gte("+n(e.operands)+")";case"infix-lt":return s.push("lt"),c+"lt("+n(e.operands)+")";case"infix-lte":return s.push("lte"),c+"lte("+n(e.operands)+")"}throw TypeException("Unknown operator: "+e.subtype);case"group":return"("+t(e.exp)+")";case"function":switch(s.push(e.name.toLowerCase()),e.name){case"if":return c+"branch( "+r(e.args)+" )";case"and":case"or":default:return c+e.name.toLowerCase()+"( "+r(e.args)+" )"}case"cell":return"undefined"==typeof a||o||a.push(e),'context.get("'+e.addr+'")';case"range":return"undefined"!=typeof a&&(a.push(e),o=!0),u=t(e.topLeft),i=t(e.bottomRight),o=!1,"function"===e.topLeft.type&&(u="function() { return ("+u+"); }"),"function"===e.bottomRight.type&&(i="function() { return ("+i+"); }"),"context.range( "+u+", "+i+" )";case"value":switch(e.subtype){case"array":return"["+n(e.items)+"]";case"string":return"'"+e.value.replace(/'/g,"''")+"'";case"variable":return a&&!o&&a.push(e),'context.get("'+e.value+'")';default:return e.value}}}var u,i=e,o=!1,a=[],s=[],c="this.";"string"==typeof i&&(i=_parser.parser.parse(e));var p=compiledNumber++,d=t(i);return u=new Function("context","// "+e+"\n  return ("+d+");\n  //@ sourceURL=formula_function_"+p+".js'\n  "),u.id=p,u.exp=e,u.ast=i,u.code=d,u.precedents=a,u.requires=s,u}function run(e){var r=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],n=arguments[2],t=compile(e),u=n;return"undefined"==typeof n&&(u=t.requires.reduce(function(e,r){return e[r]=FF[r],e},{})),"function"!==r.get&&(r.get=function(e){return r[e]}),console.log(t.requires,u),t.bind(u)(r)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.compile=compile,exports.run=run;var _parser=require("./parser"),_functionfoundry=require("functionfoundry"),FF=_interopRequireWildcard(_functionfoundry),compiledNumber=0;
